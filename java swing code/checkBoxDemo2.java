import javax.swing.*;
import java.awt.*;
import java.awt.event.*;//iteamlistener
...
//add checkbox to button group.user able to select only one checkbox
        ...
        //create itemlistener useing class
        Handler handler=new Handler();//create handler

        checkbox1.addItemListener(handler);//adding item listener to checkbox
        checkbox2.addItemListener(handler);
        checkbox3.addItemListener(handler);
    }
    //create itemlistener handler class
   class Handler  implements ItemListener{
      public void itemStateChanged(ItemEvent e){//e =obj
        //conditions
...
public static void main(String[]args)
   {
     checkBoxDemo2 a=new checkBoxDemo2();
